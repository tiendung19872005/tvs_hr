...
import MBHRAP002_1 from "./MBHRAP002_1";
import MBHRAP002_2 from "./MBHRAP002_2";
import MBHRAP002_3 from "./MBHRAP002_3";
...
export default class MBHRAP002 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isModalOpen: false,
    ...
    getData = async (p_fromdate = moment(this.state.startingDay).format("YYYYMMDD"), p_todate = moment(this.state.endingDay).format("YYYYMMDD")) => {
        ...
        let procedure = "STV_HR_SEL_MBI_MBHRAP002_0";
