...
export default class MBHRAP002_1 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checkboxes: [],
            ...
            .then((res) => {
                ...
                if (data_info.totalrows > 0) {
                    if (data_info.records[0].status == "OK") {
                        ...
                        variables.toastSuccessful.text = 'Phê duyệt tăng ca thành công!'
                        Toast.show(toast)
                        this.calc();
                        ...
                        if (data_info.records[0].error_ex != "") {
                            ...
                            let toast = variables.toastError;
                            toast.text = 'Phê duyệt tăng ca thất bại!'
                            Toast.show(toast)
                            return;
                        }
                        ...
                        <View style={styles.cart}>
                            ...
                            <Right>
                                <Text style={[styles.textCart1Value, { color: variables.textValue, }]}>
                                    {!!item.time_in ? item.time_in : `--:--`} - {!!item.time_out ? item.time_out : `--:--`}
                                </Text>
                            </Right>
                            <View style={GlobalStyles.spaceHorizontalSmall}></View>
                        </View>
        ...
        return (
            <Container>
                ...
                <DialogInput isDialogVisible={this.state.isDialogVisible}
                    ...
                    submitText='Ok'
                    cancelText='Hủy'
                    textInputProps={{ height: 50, backgroundColor: 'red' }}
