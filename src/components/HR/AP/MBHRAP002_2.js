...
export default class MBHRAP002_2 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checkboxes: [],
            ...
            .then((res) => {
                ...
                if (data_info.totalrows > 0) {
                    if (data_info.records[0].status == "OK") {
                        ...
                        variables.toastSuccessful.text = 'Hủy phê duyệt tăng ca thành công!'
                        Toast.show(toast)
                        this.calc();
                        ...
                        if (data_info.records[0].error_ex != "") {
                            ...
                            let toast = variables.toastError;
                            toast.text = 'Hủy phê duyệt tăng ca thất bại!'
                            Toast.show(toast)
                            return;
                        }
    ...
    comfirmAlert(p_approve_status) {
        ...
        Alert.alert(
            'Hủy phê duyệt tăng ca',
            'Bạn có chắc chắn muốn hủy phê duyệt?',
            [
