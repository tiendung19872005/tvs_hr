...
export default class MBHRAP001_3 extends Component {
    constructor(props) {
        super(props);
        this.state = {
            checkboxes: [],
            ...
            .then((res) => {
                ...
                if (data_info.totalrows > 0) {
                    if (data_info.records[0].status == "OK") {
                        ...
                        variables.toastSuccessful.text = 'Không phê duyệt vắng thành công!'
                        Toast.show(toast)
                        this.calc();
                        ...
                        if (data_info.records[0].error_ex != "") {
                            ...
                            let toast = variables.toastError;
                            toast.text = 'Không phê duyệt vắng thất bại!'
                            Toast.show(toast)
                            return;
                        }
                    }
