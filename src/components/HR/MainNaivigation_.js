          ...
          <Container style={{ backgroundColor: 'white', }}>
            ...
            <FlatList
              ...
              renderItem={({ item, index }) => {
                return (
                  <View key={index} style={[styles.child, { backgroundColor: item.bgcolor }]}>
                    <TouchableOpacity key={index} onPress={() => this.navigationScreens(item.form_url, item.title, navigation)} >
                      <MaterialCommunityIcons name={item.icon} style={{ fontSize: 45, color: 'white', alignSelf: 'center' }}></MaterialCommunityIcons>
