...
import { AppRegistry, View, RefreshControl, Image, StatusBar, FlatList, StyleSheet, Platform, Dimensions, TouchableOpacity, TouchableWithoutFeedback, Modal, TouchableHighlight } from "react-native";
import {
...
class MBHRIN002 extends Component {
    ...
    getData = async (p_fromdate = moment(this.state.startingDay).format("YYYYMMDD"), p_todate = moment(this.state.endingDay).format("YYYYMMDD")) => {
        ...
        let procedure = "STV_HR_SEL_MBI_MBHRIN002_0";
        ...
        return (
            <View
                ...
                <View style={styles.cart, { borderBottomWidth: 0.5, borderColor: 'gray', paddingBottom: 5, marginBottom: 7, marginLeft: 5 }}>
                    <Text style={[styles.textCartHeder, { marginTop: 0, paddingTop: 0, alignSelf: 'flex-start' }]}>Ngày: <Text style={{ color: variables.textValue }}>{moment(item.work_date).format('DD-MM-YYYY')} ({Number.isInteger(parseInt(item.day_type)) ? `Thứ ${item.day_type}` : `${item.day_type}`})</Text></Text>
                ...
                <View style={{ borderWidth: 0.7, borderColor: '#d9e1e8', borderRadius: 10, marginLeft: 5 }}>
                    ...
                    <View style={styles.cart1}>
                        ...
                        <Right style={styles.borderLeft}>
                            <Text style={[styles.textCart1Value, {}]}>{item.wt}</Text>
                        </Right>
                    </View>
                    ...
                    <View style={styles.cart1}>
                        ...
                        <Right style={styles.borderLeft}>
                            <Text style={[styles.textCart1Value, {}]}>{item.ot}</Text>
                        </Right>
                    </View>
                    ...
                    <View style={styles.cart1}>
                        ...
                        <Right style={styles.borderLeft}>
                            <Text style={[styles.textCart1Value, {}]}>{item.abs_name}</Text>
                        </Right>
                    </View>
                    ...
                    <View style={styles.cart1}>
                        ...
                        <Right style={styles.borderLeft}>
                            <Text style={[styles.textCart1Value, {}]}>{item.abs_time}</Text>
                        </Right>
                    </View>
                </View>
            </View>
